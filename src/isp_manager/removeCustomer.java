...
public class removeCustomer extends javax.swing.JPanel {
    ...
    public removeCustomer(String id) {
        ...
        stm = con.prepareStatement("delete from customer where username = ?");
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Username (customer):");
        ...
        usernameField.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(51, 51, 51), 2, true));
        ...
        removeBGLayout.setVerticalGroup(
            removeBGLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(removeButton, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 48, Short.MAX_VALUE)
        );
        ...
        blockBGLayout.setVerticalGroup(
            blockBGLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(blockButton, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 48, Short.MAX_VALUE)
        );
        ...
        passField1.setHorizontalAlignment(javax.swing.JTextField.LEFT);
        passField1.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(51, 51, 51), 2, true));
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(passField1, javax.swing.GroupLayout.DEFAULT_SIZE, 239, Short.MAX_VALUE)
    ...
    private void removeButtonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_removeButtonMouseClicked
        ...
        try {
            ...
            warningLabel.setText("Customer removed");
        }   catch(Exception e) {}
    ...
    private void blockButtonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_blockButtonMouseClicked
        ...
        try {
            con = DriverManager.getConnection("jdbc:sqlite:isp_manager.db"); // established connection
            stm = con.prepareStatement("update customer set active = ? where username = ?");
            ...
            warningLabel.setText("Customer blocked");
        }   catch(Exception e) {}
